...
req.on("response", (h, f) => {
    console.log(`/tests/get/ request completed in ${performance.now() - testsGetStart}ms`);
    console.log(h);
    console.log(f);
    console.log("\n\n");
});
...
req2.on("response", (h, f) => {
    console.log(`/merged/tests/get/ request completed in ${performance.now() - mergedTestsGetStart}ms`);
    console.log(h);
    console.log(f);
    console.log("\n\n");
});
